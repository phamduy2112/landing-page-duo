...
const TESTIMONIALS = [
  ...
  },
  {
    ...
    role: "Đạt 95 DET",
    text:
     "Điều mình thích nhất ở Duo Center là giáo trình dễ hiểu và phương pháp giảng dạy cực kỳ thực tế. Sau khóa học, mình không chỉ đạt điểm cao mà còn sử dụng tiếng Anh tự tin hơn hẳn!",
  },
